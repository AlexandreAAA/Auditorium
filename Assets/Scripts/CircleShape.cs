...
namespace Auditorium
{
    ...
    public class CircleShape : MonoBehaviour
    {
        ...
        {
            get { return _lineRenderer = _lineRenderer != null ? _lineRenderer : GetComponent<LineRenderer>(); }
        }
        ...
        private CircleCollider2D CircleCollider
        {
            get
            {
                return _circleCollider = _circleCollider != null ? _circleCollider : GetComponent<CircleCollider2D>();
            }
        }
